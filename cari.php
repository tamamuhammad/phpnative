...
include 'header1.php';
$cari = $_GET["cari"];
$result = mysqli_query($conn, "SELECT * FROM artikel WHERE judul LIKE '%$cari%' OR teks LIKE '%$cari%'");
...
<div>
    ...
    <img src="admin/<?php echo $row['gambar']?>" width="308px" style="float: right; margin: 0">
        <div style="padding: 15px; padding-top: 0px;">
            ...
            <p><?php echo substr($row['teks'], 0, 200)?>...</p>
            <button style="border-radius: 10px; background-color: seagreen; width: 200px; height: 50px;"><a href="artikel.php?id=<?php echo $row['id'] ?>">LIHAT SELENGKAPNYA</a></button><br>
        </div>
    </div>
    <?php endwhile;?>
</div>
